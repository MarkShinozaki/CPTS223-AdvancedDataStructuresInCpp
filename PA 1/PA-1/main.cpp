/*
Mark Shinozaki 
PA 1 - Linux matching game

pros and cons of array andthe linked lists????
pros of what? linkedlists
- you can easily do insertions and deletions 
- you can decrease and increase the linked list at run time 
- memory is well utilized in the linked list becauswe we do not allocate mem in advance 
- you can implement stacks and queues 

cons -st
- reverse travsering in a linked list is difficult a s


arrays 

pros
- accessing an element is very by using index
cons 

- arrays are fixed memory and size at be changed at run-time
- array siz
*/
